  ...
  return (
    <div>
      ...
      <div className="newpancard_2">
        <div><a href="/UpdatePancardForm/Individual-all-state"><p>Update Pan Card With Aadhaar <br /> <i>(All States)</i></p></a></div>
        <div><a href="/UpdatePancardForm/Individual-union-territory"><p>Update Pan Card Without Aadhaar <br /><i>(Only ASSAM, JAMMU AND KASHMIR, MEGHALAYA)</i></p></a></div>
      </div>
